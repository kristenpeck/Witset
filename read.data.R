...
# location of application or capture- should be "Campgroup" or "Canyon"
...
t.tagrecoveries <- read.csv(t.tagrecoveries, header=TRUE, as.is=TRUE, strip.white=TRUE)
...
t.markedunmarked      <- read.csv(t.markedunmarked, header=TRUE, as.is=TRUE, strip.white=TRUE)
...
n.counts <- readxl::read_excel(n.counts.file, sheet="Sheet1",
                               .name_repair = "universal")
n.counts$Species < "SK"
head(n.counts)
